...
- 수요일 03:10: 전날 화요일 21시 AI 라이브 처리
- 수요일 05:10: 완료되지 않은 경우 같은 AI 라이브 재처리
- 수요일 10:10: 완료되지 않은 경우 같은 AI 라이브 최종 확인
- 금요일 01:10: 전날 목요일 19시 비즈니스 라이브 처리
- 금요일 03:10: 완료되지 않은 경우 같은 비즈니스 라이브 재처리
- 금요일 08:10: 완료되지 않은 경우 같은 비즈니스 라이브 최종 확인
